...
# Matomo instance
.PHONY: matomo-start
matomo-start: # Start matomo instance
	@echo "$(GREEN)==> Start matomo$(RESET)"
	docker compose -f $(BACKEND_FOLDER)/docker-compose.yml up -d

.PHONY: matomo-stop
matomo-stop: # Stop matomo instance
	@echo "$(GREEN)==> Start matomo$(RESET)"
	docker compose -f $(BACKEND_FOLDER)/docker-compose.yml down
